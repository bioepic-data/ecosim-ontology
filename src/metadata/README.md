 ...
 * [bervo.yml](bervo.yml)
     * Determines how your purl.obolibrary.org/obo/bervo/ redirects will be handled
     ...
     * Paste in the contents of [bervo.yml](bervo.yml)
 ...
 * [bervo.md](bervo.md)
     ...
     * Paste in the contents of [bervo.md](bervo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
