 ...
 * [ecosim.yml](ecosim.yml)
     * Determines how your purl.obolibrary.org/obo/ecosim/ redirects will be handled
     ...
     * Paste in the contents of [ecosim.yml](ecosim.yml)
 ...
 * [ecosim.md](ecosim.md)
     ...
     * Paste in the contents of [ecosim.md](ecosim.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
